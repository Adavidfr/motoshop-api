...
def send_newsletter_invitation(email):
    ...
    html_body = f"""
        ...
        <div style="text-align: center; margin: 45px 0;">
            <a href="https://aura-rider.uaeftt-ute.site/register" style="background-color: #e50914; color: #ffffff; text-decoration: none; padding: 16px 36px; border-radius: 8px; font-weight: 800; font-size: 16px; display: inline-block; box-shadow: 0 6px 20px rgba(229, 9, 20, 0.4); text-transform: uppercase; letter-spacing: 1px;">Crear Mi Cuenta Ahora</a>
        </div>
